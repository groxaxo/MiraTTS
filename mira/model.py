...
class MiraTTS:
    ...
    def __init__(
        ...
        Args:
            model_path: Path to ONNX model directory OR HuggingFace model ID.
                       Default: "uetuluk2/MiraTTS-onnx-int4" (recommended INT4 quantized model)
    ...
    def split_text(self, text: str, normalize: bool = True, normalization_options: NormalizationOptions = None) -> List[str]:
        """
    ...
    def generate(self, text: str, context_tokens: str, normalize: bool = True, normalization_options: NormalizationOptions = None) -> torch.Tensor:
        """
